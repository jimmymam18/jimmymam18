  ...
  Widget build(BuildContext context) {
    return WillPopScope(onWillPop: (){
      ...
      child: Scaffold(
          appBar: AppBar(
            titleSpacing: 2,
            leading: Padding(padding: EdgeInsets.only(left: 0,right: 0,bottom: 0,top: 0),
              child: IconButton(icon: Image.asset('assets/Images/back.png', scale: 7,),
                onPressed: (){
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>GuestHomePage(indexCount: '0')));
                },),),
            centerTitle: true,
            title: Text(widget.titleName,style: TextStyle(fontSize: 20,fontFamily: "Montserrat"),textAlign: TextAlign.center),
                      ...
                      if (snapshot.hasData) {
                        ...
                        return new ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int position) {
                            ...
                            return widget.titleName == postList[position].categoryName && userId != postList[position].userId
                                ?Container(
