class API{
  ...
  static const String stripePublishableKey = 'pk_live_c5E5SMdZOShtWacsFRzf5YIN00lVDBJtaL'; //live key

  // static const String baseUrl = "http://13.59.162.217:8000/";
  static const String baseUrl = "https://bizit.me/";

  static const String payment_API_bid_confirmation_web = baseUrl + "payment_API_bid_confirmation_web/";
  static const String refund_api_web = baseUrl + "refund_api_web/";
