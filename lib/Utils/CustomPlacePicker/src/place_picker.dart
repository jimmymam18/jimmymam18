...
import 'package:bizitme/Utils/CustomPlacePicker/src/autocomplete_search.dart';
import 'package:bizitme/Utils/CustomPlacePicker/src/controllers/autocomplete_search_controller.dart';
import 'package:bizitme/Utils/CustomPlacePicker/src/google_map_place_picker.dart';
import 'package:bizitme/Utils/CustomPlacePicker/src/utils/uuid.dart';
...
class _PlacePickerState extends State<PlacePicker> {
  ...
  _pickPrediction(Prediction prediction) async {
    ...
    final PlacesDetailsResponse response = await provider .places.getDetailsByPlaceId(
      ...
      fields: ["name","formatted_address","name","geometry"]
    );
