...
import 'package:bizitme/Utils/CustomPlacePicker/providers/search_provider.dart';
import 'package:bizitme/Utils/CustomPlacePicker/src/components/prediction_tile.dart';
import 'package:bizitme/Utils/CustomPlacePicker/src/components/rounded_frame.dart';
import 'package:bizitme/Utils/CustomPlacePicker/src/controllers/autocomplete_search_controller.dart';
  ...
  _performAutoCompleteSearch(String searchTerm) async {
    ...
    if (searchTerm.isNotEmpty) {
      final PlacesAutocompleteResponse response = await provider.places.autocomplete(
        ...
        location: provider.currentPosition == null ? null :
